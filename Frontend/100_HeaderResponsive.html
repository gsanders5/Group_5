...
<body class="has-standard-header body-bg-white page-has-left-panels page-has-right-panels">
...
<div class="header--standard header--standard-dark" id="header--standard">
	<div class="container">
		<div class="header--standard-wrap">
			<a href="02-ProfilePage.html" class="logo">
				<div class="img-wrap">
					<img loading="lazy" src="img/logo-colored-small.webp" width="34" height="34" alt="Olympus">
				</div>
				<div class="title-block">
					<h6 class="logo-title">olympus</h6>
...
<div class="container">
	<div class="row mt50">
		...
		<div class="col col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
			<div class="ui-block mb60">
				...
				<article class="hentry blog-post single-post single-post-v3">
					...
					<div class="author-date">
						<div class="author-thumb">
							<img alt="author" src="img/friend-harmonic7.webp" class="avatar">
						</div>
						by
					...
					<div class="post-thumb">
						<img loading="lazy" src="img/post-thumb1.webp" alt="author" width="768" height="441">
					</div>
					...
					<div class="post-content-wrap">
						...
						<div class="post-content">
							...
							<div class="video-thumb bg-violet">
								<img loading="lazy" src="img/video-thumb.webp" alt="video" width="210" height="158">
			...
			<!-- ... end Comments -->
			<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12  align-center">
			...
			<aside class="blog-post-wrap">
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3 featured-post-item">
						...
						<div class="post-thumb">
							<img loading="lazy" src="img/post13.webp" alt="photo" width="368" height="180">
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3 featured-post-item">
						...
						<div class="post-thumb">
							<img loading="lazy" src="img/post14.webp" alt="photo" width="400" height="200">
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3 featured-post-item">
						...
						<div class="post-thumb">
							<img loading="lazy" src="img/post15.webp" alt="photo" width="376" height="204">
							<a href="#" class="post-category bg-purple">INSPIRATION</a>
						</div>
				...
				<div class="ui-block">
					...
					<article class="hentry blog-post blog-post-v3 featured-post-item">
						...
						<div class="post-thumb">
							<img loading="lazy" src="img/post16.webp" alt="photo" width="370" height="189">
							<a href="#" class="post-category bg-primary">OLYMPUS NEWS</a>
						</div>
...
<div class="footer footer--dark has-not-copyright" id="footer">
	<div class="container">
		<div class="row">
			<div class="col col-lg-4 col-md-4 col-sm-12 col-12">
				<div class="widget w-about">
					<a href="02-ProfilePage.html" class="logo">
						<div class="img-wrap">
							<img loading="lazy" src="img/logo-colored.webp" alt="Olympus" width="60" height="60">
						</div>
						<div class="title-block">
							<h6 class="logo-title">olympus</h6>
							<div class="sub-title">SOCIAL NETWORK</div>
