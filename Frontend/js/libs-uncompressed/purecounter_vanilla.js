!function (e) {
	...
	function n() {
		...
		if ("IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype) for (var t = new IntersectionObserver(o, {
			root: null,
			rootMargin: "20px",
			threshold: .5
		}), n = 0; n < e.length; n++) t.observe(e[n]); else window.addEventListener && (r(e), window.addEventListener("scroll", function (t) {
			r(e)
		}, {passive: !0}))
	}
	...
	function o(e, t) {
		e.forEach(function (e) {
			...
			return n.duration <= 0 ? e.innerHTML = n.end.toFixed(n.decimals) : !t && !u(e) || t && e.intersectionRatio < .5 ? e.target.innerHTML = n.start > n.end ? n.end : n.start : void setTimeout(function () {
	...
	function i(e, t) {
		var n = (t.end - t.start) / (t.duration / t.delay), r = "inc";
		...
		var i = setInterval(function () {
			var a = function (e, t, n, r) {
				r || (r = "inc");
				if ("inc" === r) return n.decimals <= 0 ? parseInt(e) + parseInt(t) : parseFloat(e) + parseFloat(t);
				return n.decimals <= 0 ? parseInt(e) - parseInt(t) : parseFloat(e) - parseFloat(t)
			}(o, n, t, r);
			...
			}(a, t), ((o = a) >= t.end && "inc" == r || o <= t.end && "dec" == r) && (clearInterval(i), o != t.end && (e.innerHTML = t.decimals <= 0 ? parseInt(t.end) : parseFloat(t.end).toFixed(t.decimals)))
		}, t.delay)
	}
	...
	function a(e) {
		for (var t = [].filter.call(e.attributes, function (e) {
			...
			n[o.toLowerCase()] = "duration" == o.toLowerCase() ? parseInt(1e3 * s(t[r].value)) : s(t[r].value)
		}
		return n
	}
