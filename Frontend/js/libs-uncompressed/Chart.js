		...
		1: [function (t, e, a) {
			...
			function i(t) {
				if (t) {
					...
					if (l) {
						l = l[1];
						for (d = 0; d < r.length; d++) r[d] = parseInt(l[d] + l[d], 16)
					} else if (l = t.match(a)) {
						l = l[1];
						for (d = 0; d < r.length; d++) r[d] = parseInt(l.slice(2 * d, 2 * d + 2), 16)
					} else if (l = t.match(i)) {
						for (d = 0; d < r.length; d++) r[d] = parseInt(l[d + 1]);
						s = parseFloat(l[4])
					} else if (l = t.match(n)) {
						for (d = 0; d < r.length; d++) r[d] = Math.round(2.55 * parseFloat(l[d + 1]));
						s = parseFloat(l[4])
					} else if (l = t.match(o)) {
			...
			var c = t(6);
			e.exports = {
				getRgba: i, getHsla: n, getRgb: function (t) {
					var e = i(t);
			...
			var i = t(5), n = t(2), o = function (t) {
				...
				} else if ("object" == typeof t) if (void 0 !== (e = t).r || void 0 !== e.red) this.setValues("rgb", e); else if (void 0 !== e.l || void 0 !== e.lightness) this.setValues("hsl", e); else if (void 0 !== e.v || void 0 !== e.value) this.setValues("hsv", e); else if (void 0 !== e.w || void 0 !== e.whiteness) this.setValues("hwb", e); else {
			...
			o.prototype = {
				rgb: function () {
					...
					for (var r in i) i.hasOwnProperty(r) && (t = i[r], "[object Array]" === (e = {}.toString.call(t)) ? n[r] = t.slice(0) : "[object Number]" === e ? n[r] = t : console.error("unexpected color value:", t));
					return a
				}
			}, o.prototype.spaces = {
				rgb: ["red", "green", "blue"],
			...
			function c(t) {
				...
				for (var u = 0; u < 3; u++) (i = r + 1 / 3 * -(u - 1)) < 0 && i++, i > 1 && i--, o = 6 * i < 1 ? e + 6 * (a - e) * i : 2 * i < 1 ? a : 3 * i < 2 ? e + (a - e) * (2 / 3 - i) * 6 : e, n[u] = 255 * o;
				return n
			}
			...
			for (var I in w) C[JSON.stringify(w[I])] = I
		}, {}], 5: [function (t, e, a) {
				...
				t.defaults.bar = {
					...
					getRuler: function () {
						var t = this, e = t.getMeta(), a = t.getScaleForId(e.xAxisID), i = t.getStackCount(),
							n = a.width / a.ticks.length, o = n * a.options.categoryPercentage, r = o / i;
						return {
							stackCount: i,
							tickWidth: n,
							categoryWidth: o,
					...
					getStackIndex: function (t) {
						var e, a, i = this, n = i.chart.getDatasetMeta(t), o = i.getScaleForId(n.yAxisID),
							r = [n.stack];
						for (a = 0; a < t; ++a) (e = this.chart.getDatasetMeta(a)).bar && this.chart.isDatasetVisible(a) && (!1 === o.options.stacked || !0 === o.options.stacked && -1 === r.indexOf(e.stack) || void 0 === o.options.stacked && (void 0 === e.stack || -1 === r.indexOf(e.stack))) && r.push(e.stack);
						return r.length - 1
					},
					...
					getStackCount: function () {
						...
						var t = this, e = t.getMeta(), a = t.getScaleForId(e.yAxisID), i = t.getStackCount(),
							n = a.height / a.ticks.length, o = n * a.options.categoryPercentage, r = o / i;
						return {
							stackCount: i,
							tickHeight: n,
							categoryHeight: o,
			...
			e.exports = function (t) {
				...
				t.defaults.bubble = {
					...
					setHoverStyle: function (a) {
						...
						var n = i.chart.data.datasets[a._datasetIndex], o = a._index, r = a.custom || {};
					...
					removeHoverStyle: function (e) {
						...
						var i = a.chart.data.datasets[e._datasetIndex].data[e._index], n = e.custom || {};
				...
				a.doughnut = {
					...
					legend: {
						labels: {
							...
							for (a = 0, i = (r.data.datasets || []).length; a < i; ++a) (n = r.getDatasetMeta(a)).data[o] && (n.data[o].hidden = !n.data[o].hidden);
							r.update()
						}
					},
					cutoutPercentage: 50,
					...
					update: function (t) {
						...
						if (f < 2 * Math.PI) {
							var g = o.rotation % (2 * Math.PI),
								...
								m = {x: Math.cos(g), y: Math.sin(g)}, v = {x: Math.cos(p), y: Math.sin(p)},
							...
							u = Math.min(s / C.width, l / C.height), d = {x: -.5 * (w.x + M.x), y: -.5 * (w.y + M.y)}
						}
					...
					getMaxBorderWidth: function (t) {
						for (var e, a, i = 0, n = this.index, o = t.length, r = 0; r < o; r++) e = t[r]._model ? t[r]._model.borderWidth : 0, i = (a = t[r]._chart ? t[r]._chart.config.data.datasets[n].hoverBorderWidth : 0) > (i = e > i ? e : i) ? a : i;
						return i
					}
				})
			}
			...
			e.exports = function (t) {
				...
				t.defaults.line = {
					...
					updateElement: function (t, e, i) {
						...
						void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius), void 0 !== u.hitRadius && void 0 === u.pointHitRadius && (u.pointHitRadius = u.hitRadius), n = f.getPixelForValue("object" == typeof c ? c : NaN, e, d, p), o = i ? h.getBasePixel() : r.calculatePointY(c, e, d), t._xScale = f, t._yScale = h, t._datasetIndex = d, t._index = e, t._model = {
							x: n,
							y: o,
					...
					calculatePointY: function (t, e, a) {
						...
						if (u.options.stacked) {
							for (i = 0; i < a; i++) if (n = s.data.datasets[i], "line" === (o = s.getDatasetMeta(i)).type && o.yAxisID === u.id && s.isDatasetVisible(i)) {
					...
					updateBezierControlPoints: function () {
						...
						var e, i, n, o, r = this, s = r.getMeta(), l = r.chart.chartArea, u = s.data || [];
						if (s.dataset._model.spanGaps && (u = u.filter(function (t) {
								return !t._model.skip
							})), "monotone" === s.dataset._model.cubicInterpolationMode) a.splineCurveMonotone(u); else for (e = 0, i = u.length; e < i; ++e) n = u[e]._model, o = a.splineCurve(a.previousItem(u, e)._model, n, a.nextItem(u, e)._model, s.dataset._model.tension), n.controlPointPreviousX = o.previous.x, n.controlPointPreviousY = o.previous.y, n.controlPointNextX = o.next.x, n.controlPointNextY = o.next.y;
						if (r.chart.options.elements.line.capBezierPoints) for (e = 0, i = u.length; e < i; ++e) (n = u[e]._model).controlPointPreviousX = t(n.controlPointPreviousX, l.left, l.right), n.controlPointPreviousY = t(n.controlPointPreviousY, l.top, l.bottom), n.controlPointNextX = t(n.controlPointNextX, l.left, l.right), n.controlPointNextY = t(n.controlPointNextY, l.top, l.bottom)
					},
					draw: function (a) {
					...
					legend: {
						labels: {
							generateLabels: function (t) {
								var a = t.data;
								return a.labels.length && a.datasets.length ? a.labels.map(function (i, n) {
									var o = t.getDatasetMeta(0), r = a.datasets[0], s = o.data[n].custom || {},
										l = e.getValueAtIndexOrDefault, u = t.options.elements.arc;
									return {
										text: i,
							...
							var a, i, n, o = e.index, r = this.chart;
							for (a = 0, i = (r.data.datasets || []).length; a < i; ++a) (n = r.getDatasetMeta(a)).data[o].hidden = !n.data[o].hidden;
							r.update()
						}
					},
					tooltips: {
			...
			e.exports = function (t) {
				...
				e.drawPoint = function (e, a, i, n, o) {
					var r, s, l, u, d, c;
					if ("object" != typeof a || "[object HTMLImageElement]" !== (r = a.toString()) && "[object HTMLCanvasElement]" !== r) {
						if (!(isNaN(i) || i <= 0)) {
							switch (a) {
								default:
			...
			e.exports = function (t) {
				...
				t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (a, n, r) {
					...
					initialize: function () {
						...
						for (s.stop(), a = 0, r = s.data.datasets.length; a < r; ++a) (e = s.getDatasetMeta(a)).controller && (e.controller.destroy(), e.controller = null);
			...
			e.exports = function (t) {
				...
				o.each = function (t, e, a, i) {
					...
					return o.each(t, function (t, a) {
						o.isArray(t) ? e[a] = t.slice(0) : e[a] = "object" == typeof t && null !== t ? o.clone(t) : t
					}), e
				}, o.extend = function (t) {
					for (var e = 1, a = arguments.length; e < a; e++) o.each(arguments[e], function (e, a) {
						t[a] = e
					});
					return t
					...
					for (e = 0; e < s; ++e) if (!(i = r[e]).model.skip) {
					...
					var u, d, c, h;
					for (e = 0; e < s - 1; ++e) i = r[e], n = r[e + 1], i.model.skip || n.model.skip || (o.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = n.mK = 0 : (u = i.mK / i.deltaK, d = n.mK / i.deltaK, (h = Math.pow(u, 2) + Math.pow(d, 2)) <= 9 || (c = 3 / Math.sqrt(h), i.mK = u * c * i.deltaK, n.mK = d * c * i.deltaK)));
					var f;
					for (e = 0; e < s; ++e) (i = r[e]).model.skip || (a = e > 0 ? r[e - 1] : null, n = e < s - 1 ? r[e + 1] : null, a && !a.model.skip && (f = (i.model.x - a.model.x) / 3, i.model.controlPointPreviousX = i.model.x - f, i.model.controlPointPreviousY = i.model.y - f * i.mK), n && !n.model.skip && (f = (n.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + f, i.model.controlPointNextY = i.model.y + f * i.mK))
				}, o.nextItem = function (t, e, a) {
					return a ? e >= t.length - 1 ? t[0] : t[e + 1] : e >= t.length - 1 ? t[t.length - 1] : t[e + 1]
				}, o.previousItem = function (t, e, a) {
					return a ? e <= 0 ? t[t.length - 1] : t[e - 1] : e <= 0 ? t[0] : t[e - 1]
				}, o.niceNum = function (t, e) {
					var a = Math.floor(o.log10(t)), i = t / Math.pow(10, a);
				...
				o.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
					...
					var n = (i = i || {}).data = i.data || {}, r = i.garbageCollect = i.garbageCollect || [];
			...
			e.exports = function (t) {
				...
				function a(t, e) {
					var a, i, n, o, r;
					for (i = 0, o = t.data.datasets.length; i < o; ++i) if (t.isDatasetVisible(i)) for (n = 0, r = (a = t.getDatasetMeta(i)).data.length; n < r; ++n) {
						var s = a.data[n];
						s._view.skip || e(s)
					}
				}
				...
				function o(t, a, o) {
					var r = e(a, t.chart), s = o.intersect ? i(t, r) : n(t, r, !1, function (t, e) {
					...
					defaults: {}, addBox: function (t, e) {
						...
						function n(t) {
							...
							if (a) if (t.isHorizontal()) {
								var i = {left: Math.max(T, C), right: Math.max(P, I), top: 0, bottom: 0};
						...
						if (t) {
							var r = t.options.layout, s = r ? r.padding : null, l = 0, u = 0, d = 0, c = 0;
							...
							var v = a - l - u, b = i - d - c, x = b / 2, y = (a - v / 2) / (h.length + f.length),
								k = (i - x) / (g.length + p.length), S = v, M = b, w = [];
			...
			e.exports = function (t) {
				...
				t.defaults.global.plugins = {}, t.plugins = {
					_plugins: [], _cacheId: 0, register: function (t) {
						...
						for (i = 0; i < u; ++i) if (n = l[i], o = n.plugin, "function" == typeof(s = o[e]) && ((r = [t].concat(a || [])).push(n.options), !1 === s.apply(o, r))) return !1;
						return !0
					...
					fit: function () {
						...
						if (n.width = d ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : u && l.drawTicks ? f : 0, n.height = d ? u && l.drawTicks ? f : 0 : t.maxHeight, s.display && u && (d ? n.height += h : n.width += h), r.display && u) {
							...
							if (d) {
								...
								var v = i.toRadians(t.labelRotation), b = Math.cos(v),
									x = Math.sin(v) * g + c.size * p + m * p;
								n.height = Math.min(t.maxHeight, n.height + x), t.ctx.font = c.font;
								var y = t.ticks[0], k = e(t.ctx, y, c.font), S = t.ticks[t.ticks.length - 1],
									M = e(t.ctx, S, c.font);
							...
							if (i.each(n.ticks, function (t, a) {
									if (void 0 !== t && null !== t) {
										...
										if ((!(r > 1 && a % r > 0 || a % r == 0 && a + r >= n.ticks.length) || s) && void 0 !== t && null !== t) {
											...
											var h, g, m, v, k, S, w, C, _, F, V = "middle", R = "middle";
											if (p) {
												...
												var L, B = "left" === o.position, z = d.padding;
				...
				t.defaults.global.tooltips = {
					...
					initialize: function () {
						...
						var t = this, e = t._options.callbacks, i = e.beforeTitle.apply(t, arguments),
							n = e.title.apply(t, arguments), o = e.afterTitle.apply(t, arguments), r = [];
			...
			e.exports = function (t) {
				...
				t.defaults.global.elements.line = {
					...
					draw: function () {
						...
						var c, h, f, g;
						if (u.length && n.fill) {
							for (l.beginPath(), c = 0; c < u.length; ++c) h = u[c], f = e.previousItem(u, c), g = h._view, 0 === c ? (s ? l.moveTo(r.x, r.y) : l.moveTo(g.x, r), g.skip || (d = c, l.lineTo(g.x, g.y))) : (f = -1 === d ? f : u[d], g.skip ? o || d !== c - 1 || (s ? l.lineTo(r.x, r.y) : l.lineTo(f._view.x, r)) : (d !== c - 1 ? o && -1 !== d ? t(f, h) : s ? l.lineTo(g.x, g.y) : (l.lineTo(g.x, r), l.lineTo(g.x, g.y)) : t(f, h), d = c));
							s || -1 === d || l.lineTo(u[d]._view.x, r), l.fillStyle = n.backgroundColor || a.defaultColor, l.closePath(), l.fill()
						}
						var p = a.elements.line;
						for (l.lineCap = n.borderCapStyle || p.borderCapStyle, l.setLineDash && l.setLineDash(n.borderDash || p.borderDash), l.lineDashOffset = n.borderDashOffset || p.borderDashOffset, l.lineJoin = n.borderJoinStyle || p.borderJoinStyle, l.lineWidth = n.borderWidth || p.borderWidth, l.strokeStyle = n.borderColor || a.defaultColor, l.beginPath(), d = -1, c = 0; c < u.length; ++c) h = u[c], f = e.previousItem(u, c), g = h._view, 0 === c ? g.skip || (l.moveTo(g.x, g.y), d = c) : (f = -1 === d ? f : u[d], g.skip || (d !== c - 1 && !o || -1 === d ? l.moveTo(g.x, g.y) : t(f, h), d = c));
						l.stroke(), l.restore()
					}
				})
			}
			...
			e.exports = function (t) {
				...
				var a = t.helpers, i = t.defaults.global, n = i.defaultColor;
				i.elements.point = {
					radius: 3,
					pointStyle: "circle",
					backgroundColor: n,
					...
					inRange: function (t, e) {
						...
						var o = this._view, r = this._model, s = this._chart.ctx, l = o.pointStyle, u = o.radius,
							d = o.x, c = o.y, h = t.helpers.color, f = 0;
				...
				i.elements.rectangle = {
					...
					draw: function () {
						...
						if (u.horizontal ? (e = u.base, a = u.x, i = u.y - u.height / 2, n = u.y + u.height / 2, o = a > e ? 1 : -1, r = 1, s = u.borderSkipped || "left") : (e = u.x - u.width / 2, a = u.x + u.width / 2, i = u.y, o = 1, r = (n = u.base) > i ? 1 : -1, s = u.borderSkipped || "bottom"), d) {
							var c = Math.min(Math.abs(e - a), Math.abs(i - n)), h = (d = d > c ? c : d) / 2,
								f = e + ("left" !== s ? h * o : 0), g = a + ("right" !== s ? -h * o : 0),
						...
						var v = [[e, n], [e, i], [a, i], [a, n]], b = ["bottom", "left", "top", "right"].indexOf(s, 0);
						-1 === b && (b = 0);
						var x = t(0);
						l.moveTo(x[0], x[1]);
						for (var y = 1; y < 4; y++) x = t(y), l.lineTo(x[0], x[1]);
						l.fill(), d && l.stroke()
					}, height: function () {
						var t = this._view;
						return t.base - t.y
			...
			e.exports = function (t) {
				var e = t.helpers, a = {position: "bottom"}, i = t.Scale.extend({
					getLabels: function () {
						...
						var e = this, a = Math.max(e.ticks.length - (e.options.gridLines.offsetGridLines ? 0 : 1), 1),
							i = e.isHorizontal(), n = (i ? e.width : e.height) / a;
				...
				var e = t.helpers, a = {position: "left", ticks: {callback: t.Ticks.formatters.linear}},
					i = t.LinearScaleBase.extend({
						determineDataLimits: function () {
							...
							var a = this, i = a.options, n = a.chart, o = n.data.datasets, r = a.isHorizontal();
			...
			e.exports = function (t) {
				...
				t.LinearScaleBase = t.Scale.extend({
					handleTickRangeOptions: function () {
						var t = this, a = t.options.ticks;
						if (a.beginAtZero) {
							var i = e.sign(t.min), n = e.sign(t.max);
						...
						var a = this, i = a.options.ticks, n = a.getTickLimit(), o = {
				...
				var e = t.helpers, a = {position: "left", ticks: {callback: t.Ticks.formatters.logarithmic}},
					i = t.Scale.extend({
						determineDataLimits: function () {
							...
							var a = this, i = a.options, n = i.ticks, o = a.chart, r = o.data.datasets,
								s = e.getValueOrDefault, l = a.isHorizontal();
							...
							var a = this, i = a.options.ticks, n = {min: i.min, max: i.max},
							...
							var a, i, n, o = this, r = o.start, s = +o.getRightValue(t), l = o.options.ticks;
			...
			e.exports = function (t) {
				...
				function a(t) {
					...
					return {size: a, style: i, family: n, font: f.fontString(a, i, n)}
				}
				...
				var e = t.helpers, a = {
					...
					initialize: function () {
						...
						if (i.ctx.font = s, i.ticks = [], i.unitScale = 1, i.scaleSizeInUnits = 0, i.options.time.unit) i.tickUnit = i.options.time.unit || "day", i.displayFormat = i.options.time.displayFormats[i.tickUnit], i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0), i.unitScale = e.getValueOrDefault(i.options.time.unitStepSize, 1); else {
							...
							for (var h = 0, f = a.units[h]; h < a.units.length;) {
								if (i.unitScale = 1, e.isArray(f.steps) && Math.ceil(i.scaleSizeInUnits / c) < e.max(f.steps)) {
									for (var g = 0; g < f.steps.length; ++g) if (f.steps[g] >= Math.ceil(i.scaleSizeInUnits / c)) {
						...
						if (i.options.time.min ? v = i.getMomentStartOf(i.firstTick) : (i.firstTick = i.getMomentStartOf(i.firstTick), v = i.firstTick), !i.options.time.max) {
							var b = i.getMomentStartOf(i.lastTick), x = b.diff(i.lastTick, i.tickUnit, !0);
