...
!function (t, i) {
	...
	var tt = document.documentElement.style, it = "ActiveXObject" in window, et = it && !document.addEventListener,
		nt = "msLaunchUri" in navigator && !("documentMode" in document), ot = kt("webkit"), st = kt("android"),
		rt = kt("android 2") || kt("android 3"), at = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
		ht = st && kt("Google") && at < 537 && !("AudioNode" in window), ut = !!window.opera, lt = kt("chrome"),
		ct = kt("gecko") && !ot && !ut && !it, _t = !lt && kt("safari"), dt = kt("phantom"), pt = "OTransition" in tt,
		...
		xt = "undefined" != typeof orientation || kt("mobile"), wt = xt && ot, Pt = xt && gt,
		Lt = !window.PointerEvent && window.MSPointerEvent, bt = !(!window.PointerEvent && !Lt),
		...
		Zt = !(!document.createElementNS || !$("svg").createSVGRect), Et = !Zt && function () {
			try {
	...
	var Bt = (Object.freeze || Object)({
			...
			svg: Zt,
			vml: Et
		}), At = Lt ? "MSPointerDown" : "pointerdown", It = Lt ? "MSPointerMove" : "pointermove",
		Ot = Lt ? "MSPointerUp" : "pointerup", Rt = Lt ? "MSPointerCancel" : "pointercancel",
		Nt = ["INPUT", "SELECT", "OPTION"], Dt = {}, jt = !1, Wt = 0;
	...
	function Jt(t, i) {
		var e = t[Yt + Gt + i], n = t[Yt + Kt + i], o = t[Yt + "dblclick" + i];
	...
	function Ai(i, t, e, n) {
		...
		bt && 0 === t.indexOf("touch") ? Ht(i, t, s, o) : !Tt || "dblclick" !== t || bt && lt ? "addEventListener" in i ? "mousewheel" === t ? i.addEventListener("onwheel" in i ? "wheel" : "mousewheel", s, !1) : "mouseenter" === t || "mouseleave" === t ? (s = function (t) {
			...
			!function (t, i) {
				var e = t.timeStamp || t.originalEvent && t.originalEvent.timeStamp, n = Ui && e - Ui;
	...
	function Ii(t, i, e, n) {
		var o = i + u(e) + (n ? "_" + u(n) : ""), s = t[ki] && t[ki][o];
		if (!s) return this;
	...
	var Yi = (Object.freeze || Object)({
		...
		_createAnimProxy: function () {
			...
			this._panes.mapPane.appendChild(t), this.on("zoomanim", function (t) {
				var i = ni, e = this._proxy.style[i];
	...
	var te = Qi.extend({
		options: {
			...
			var t = "leaflet-control-layers", i = this._container = hi("div", t), e = this.options.collapsed;
		...
		options: {
			...
			var i = "leaflet-control-zoom", e = hi("div", i + " leaflet-bar"), n = this.options;
	...
	var ee = Qi.extend({
		...
		onAdd: function (t) {
			var i = "leaflet-control-scale", e = hi("div", i), n = this.options;
	...
	var se, re = {Events: E}, ae = Tt ? "touchstart mousedown" : "mousedown",
		...
		le = k.extend({
			options: {clickTolerance: 3}, initialize: function (t, i, e, n) {
				...
				if (!t._simulated && this._enabled && (this._moved = !1, !di(this._element, "leaflet-zoom-anim") && !(le._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((le._dragging = this)._preventOutline && zi(this._element), bi(), $t(), this._moving)))) {
					this.fire("down");
					var i = t.touches ? t.touches[0] : t, e = Ci(this._element);
	...
	var we, Pe = (Object.freeze || Object)({clipPolygon: xe}), Le = {
		project: function (t) {
	...
	}, Te = (Object.freeze || Object)({LonLat: Le, Mercator: be, SphericalMercator: q}), ze = h({}, U, {
		code: "EPSG:3395",
		projection: be,
		transformation: (we = .5 / (Math.PI * be.R), K(we, .5, -we, .5))
	}), Me = h({}, U, {code: "EPSG:4326", projection: Le, transformation: K(1 / 180, 1, -1 / 180, .5)}), Ce = h({}, F, {
		projection: Le, transformation: K(1, 0, -1, 0), scale: function (t) {
			return Math.pow(2, t)
		}, zoom: function (t) {
	...
	var Be = ke.extend({
		...
		initialize: function (t) {
			...
			var i = this._marker, e = i._map, n = this._marker.options.autoPanSpeed,
				o = this._marker.options.autoPanPadding, s = Pi(i._icon), r = e.getPixelBounds(),
			...
			var i = this._marker, e = i._shadow, n = Pi(i._icon), o = i._map.layerPointToLatLng(n);
	...
	var Ne = Re.extend({
		...
		}, setStyle: Oe.prototype.setStyle, _project: function () {
	...
	var je = De.extend({
		options: {fill: !0}, isEmpty: function () {
			...
			var i = De.prototype._convertLatLngs.call(this, t), e = i.length;
	...
	function He(t, i) {
		var e, n, o, s, r = "Feature" === t.type ? t.geometry : t, a = r ? r.coordinates : null, h = [],
			u = i && i.pointToLayer, l = i && i.coordsToLatLng || Fe;
		if (!a && !r) return null;
		switch (r.type) {
			case"Point":
	...
	Ie.include(Ye), Ne.include(Ye), Re.include(Ye), De.include({
		...
		toGeoJSON: function (t) {
			var i = !ge(this._latlngs), e = i && !ge(this._latlngs[0]), n = qe(this._latlngs, e ? 2 : i ? 1 : 0, !0, t);
	...
	var Je = Xe, $e = Se.extend({
		options: {
			...
			var t = "IMG" === this._url.tagName, i = this._image = t ? this._url : hi("img");
		...
		options: {autoplay: !0, loop: !0, keepAspectRatio: !0}, _initImage: function () {
			var t = "VIDEO" === this._url.tagName, i = this._image = t ? this._url : hi("video");
	...
	var en = Se.extend({
		...
		options: {
			...
			if (this.options.autoPan) {
				...
				var t = this._map, i = parseInt(ai(this._container, "marginBottom"), 10) || 0,
	...
	Ji.mergeOptions({closePopupOnClick: !0}), Ji.include({
	...
	var ln = Se.extend({
		options: {padding: .1, tolerance: 0}, initialize: function (t) {
			...
			var e = this._map.getZoomScale(i, this._zoom), n = Pi(this._container),
	...
	fn.create = mn, fn.pointsToPath = Q, We.geometryToLayer = He, We.coordsToLatLng = Fe, We.coordsToLatLngs = Ue, We.latLngToCoords = Ve, We.latLngsToCoords = qe, We.getFeature = Ge, We.asFeature = Ke, Ji.mergeOptions({boxZoom: !0});
	var yn = oe.extend({
		initialize: function (t) {
	...
	var Ln = oe.extend({
		addHooks: function () {
			...
			var i = Fi(t), e = this._map.options.wheelDebounceTime;
